...
public class DBAdapters {
    private final static String DB_NAME = "product.db";      // DB名
    private final static String DB_TABLE = "prosuctSheet";   // DBのテーブル名
    ...
    public final static String COL_BRAND = "brand";        // ブランド名
     ...
     * @param price   単価
     */
    public void saveDB(String product,String brand, String madein, int number, int price) {
    ...
    public Cursor searchDBs(String[] columns, String column, String[] name) {
        return db.query(DB_TABLE, columns, column + " like ?", name, null, null, null);
    }
    /**
     * DBのレコードを全削除
