...
public class DBAdapter {
    private final static String DB_NAME = "admin.db";       // DB名
    private final static String DB_TABLE = "adminSheet";    // DBのテーブル名
    ...
    public final static String COL_EMAIL = "email";             // email
    public final static String COL_PASSWORD = "password";       // password
    private SQLiteDatabase db = null;           // SQLiteDatabase
    private DBHelper dbHelper = null;           // DBHelpler
     ...
     */
    public void saveDB(String name, String email, int password) {
    ...
    private static class DBHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            // DBからテーブル削除
            db.execSQL(new StringBuilder().append("DROP TABLE IF EXISTS").append(DB_TABLE).toString());
            // テーブル生成
            onCreate(db);
        }
    }
